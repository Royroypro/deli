...
$consulta = $pdo->prepare("SELECT p.id_pedido, p.id_cliente, p.id_restaurante, p.id_repartidor, p.estado, p.total, p.fecha, dp.id_detalle, dp.id_producto, dp.cantidad, dp.subtotal, pr.nombre
    ...
    WHERE p.id_pedido = :id_pedido AND p.id_restaurante = :id_restaurante");

$consulta->execute(['id_pedido' => $id_pedido, 'id_restaurante' => $id_restaurante_sesion]);
    ...
    <div class="mdl-cell mdl-cell--12-col">
        <div class="full-width panel mdl-shadow--2dp">
            ...
            <div class="full-width panel-content">
                <form method="post" action="./actualizar_pedido_restaurante.php">
                    ...
                    <div class="mdl-grid">
                        ...
                        <div class="mdl-cell mdl-cell--6-col">
                            <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label" style="color: green;">
                                <select class="mdl-textfield__input" name= "estado" id="estado" required>
                                    ...
                                    <option value="cancelar" <?php echo $estado == 'cancelar' ? 'selected' : ''; ?>>Cancelar</option>
                                </select>
                            </div>
                        </div>
                        <div class="mdl-cell mdl-cell--6-col">
...
<div id="notification-container" style="position: fixed; top: 10px; right: 10px; z-index: 9999;"></div>
                    ...
                    <div class="mdl-cell mdl-cell--12-col">
                            ...
                            <button class="mdl-button mdl-js-button mdl-js-ripple-effect" id="btn-refrescarPedido" style="background-color: orange;">
                                Actualizar
                            </button>
